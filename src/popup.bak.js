...
const hidePromotedAds = () => {
  ...
  arr.forEach(promoted => {
    ...
    promoted.parentNode.parentNode.parentNode.parentNode.style.display = 'none';
  });
...
const handleFilterClick = e => {
  ...
  if (
    ...
    e.target.parentElement.parentElement.hasAttribute(filterIconIdentifier) || //in case icon inside path was clicked
...
const getDataUrnEl = el => {
  ...
  } else if (el.firstElementChild.firstElementChild?.hasAttribute('data-urn')) {
